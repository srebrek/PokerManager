...
public abstract class BaseArchitectureTest
{
    ...
    protected static readonly ReflectionAssembly StatisticsAssembly = typeof(Statistics.StatisticsModule).Assembly;
    ...
    protected static readonly ReflectionAssembly[] ModuleAssemblies =
        [IdentityAssembly, GameplayAssembly, StatisticsAssembly];
